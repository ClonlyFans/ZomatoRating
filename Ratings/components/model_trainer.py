from Ratings.utils.main_utils import load_numpy_array_data
from Ratings.exception import RatingsException
from Ratings.logger import logging
from Ratings.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact
from Ratings.entity.config_entity import ModelTrainerConfig
import os,sys
...
from Ratings.utils.main_utils import save_object,load_object
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            sensor_model = RatingsModel(preprocessor=preprocessor,model=model)
